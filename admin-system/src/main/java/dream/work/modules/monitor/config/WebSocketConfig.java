package dream.work.modules.monitor.config;
...
import dream.work.modules.monitor.domain.LogMessage;
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        if(log!=null){
                            // 格式化异常堆栈信息
                            if("ERROR".equals(log.getLevel()) && "dream.work.common.exception.handler.GlobalExceptionHandler".equals(log.getClassName())){
